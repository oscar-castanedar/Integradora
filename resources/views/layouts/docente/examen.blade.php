...
@section('contenido')
    ...
    @foreach($cursos as $curso) 
      <div id="boton" class="boton" >
            <a href="{{url('/regreso',['idc'=>$curso->id])}}"><button type="button" name="btnvisualizarPre" hrfe class="btn btn-danger">Regresar</button></a>
      </div>
...
@csrf
    ...
    <input type="date" id="fechaInicio"  name="fechaInicio"  class="sm-form-control" required>
                </div>
            </td>
            <td>
                <div class="col_one_third col_last c-azul">
                    <label for="nacimiento">Fecha de Termino<small></small></label>
                    <input type="date" id="fechaFin"  name="fechaFin"  class="sm-form-control" required>
                </div>
            </td>
            </tr>
            <tr>
            ...
            <select class="form-select" name="idParcial" id="idParcial" value="0" aria-label="Default select example"  required>
                 <option selected value="0">Parciales</option>
            ...
            <td>
                <div class="form-group row" >
                    ...
                    <div class="col-sm-10">
                    <input type="number" step="0.5" min="0" autocomplete="off" name="ponderacion" class="form-control" id="ponderacion" placeholder="" required>
                    </div>
                </div>
            </td>
            ...
            <div class="card-body">
                ...
                <tbody>
                      ...
                      @foreach($examenes as $examen)
                        ...
                        <td> 
                               <a href="{{url('preguntaR',['id'=>$examen->id, 'idc'=>$curso->id])}}"><button type="button" name="btnvisualizarPre" hrfe class="btn btn-warning">Agregar Preguntas</button></a>
                        </td>

                        <td>
                
                        <a  href="{{url('/update',['id'=>$examen->id, 'idc'=>$curso->id])}}">   <button type="button"  class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
