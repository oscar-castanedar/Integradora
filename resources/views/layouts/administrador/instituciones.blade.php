  ...
  <div class="row">
    ...
    @error('telefono')
        <div class="alert alert-danger">
            El telefono debe de contar con 10 caracteres
        </div>
    @enderror
    ...
    <table class="table table-striped" style='background-color:#FFC85B;'>
        ...
        @php($i=1)
        @foreach($allInstitucion as $instituciones)
        <tr>
            <th scope="row">{{$i++}}</th>
            <td>{{$instituciones->nombre_institucion}}</td>
            <td>{{$instituciones->cct}}</td>
            <td>{{$instituciones->nombre_director}}</td>
            <td>{{$instituciones->telefono}}</td>
            <td>{{$instituciones->domicilio}}</td>
            <td>
                <form action="" method="POST">
                    <a class="btn btn-success" href="{{route('editInstitucion',['id'=>$instituciones->id])}}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                    <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                    <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                    </svg></a>
                    @csrf
                    <a class="btn btn-danger" href="{{route('deleteInstitucion',['id'=>$instituciones->id])}}" 
                ...
                <div class="modal-body">
                  <div class="tab-pane" id="tab_2">
                    <div class="box">
                      ...
                      <form class="form-horizontal" action="{{route('saveInstitucion')}}" method="POST">
                      @csrf
                      <div class="form-group">
                                <span class="col-md-1 col-md-offset-1 text-center"><i class="fa fa-user bigicon"></i>Nombre Institución</span>
                                <div class="col-md-9">
                                    <input type="text" name="nombre_institucion" class="form-control" placeholder="Nombre Institución" value="{{old('nombre_institucion')}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="cct" class="form-control" placeholder="CCT" value="{{old('cct')}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="nombre_director" class="form-control" placeholder="Nombre Director" value="{{old('nombre_director')}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="telefono" class="form-control" placeholder="Telefono" value="{{old('telefono')}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="domicilio" class="form-control" placeholder="Domicilio" value="{{old('domicilio')}}" required>
                                </div>
                            </div>
